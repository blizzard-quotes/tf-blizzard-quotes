locals {
  ...
  wc3_swagger_bucket_name           = "blizzard-quotes-wc3-swagger"
  ...
  sc2_swagger_bucket_name           = "blizzard-quotes-sc2-swagger"
  ...
  sc_swagger_bucket_name            = "blizzard-quotes-sc-swagger"
}
